...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://wordpress-1198822-4842583.cloudwaysapps.com/graphql", {
    method: "POST",
...
/** Fields in the Additional Fields group */
export type AdditionalFieldGroup = {
  __typename?: 'AdditionalFieldGroup';
...
/** Connection for fields in the Additional Fields group */
export type AdditionalFieldGroupConnection = {
  __typename?: 'AdditionalFieldGroupConnection';
  /** List of field nodes */
  nodes?: Maybe<Array<Maybe<AdditionalFieldGroup>>>;
};

/** The asset type */
export type Asset = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Asset';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<AssetToAssetConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  assetId: Scalars['Int']['output'];
  /** Connection between the asset type and the nft type */
  assetNfts?: Maybe<Asset_Asset_Nfts_Connection>;
  /** Connection between the Asset type and the asset_type type */
  assetTypes?: Maybe<AssetToAsset_TypeConnection>;
  ...
  /** Whether the asset object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the asset object. */
   ...
   */
  parent?: Maybe<AssetToParentConnectionEdge>;
  /** The password for the asset object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Asset type and the postFormat type */
  postFormats?: Maybe<AssetToPostFormatConnection>;
  /** Connection between the Asset type and the asset type */
  preview?: Maybe<AssetToPreviewConnectionEdge>;
  ...
  /** Connection between the Asset type and the TermNode type */
  terms?: Maybe<AssetToTermNodeConnection>;
...
/** The asset type */
export type AssetAssetNftsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The asset type */
export type AssetAssetTypesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<AssetToAsset_TypeConnectionWhereArgs>;
};


/** The asset type */
export type AssetContentArgs = {
...
/** The asset type */
export type AssetPostFormatsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<AssetToPostFormatConnectionWhereArgs>;
};


/** The asset type */
export type AssetTermsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<AssetToTermNodeConnectionWhereArgs>;
};
...
/** Set relationships between the asset to asset_types */
export type AssetAsset_TypesInput = {
  /** If true, this will append the asset_type to existing related asset_types. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<AssetAsset_TypesNodeInput>>>;
};

/** List of asset_types to connect the asset to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type AssetAsset_TypesNodeInput = {
  /** The description of the asset_type. This field is used to set a description of the asset_type if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the asset_type. If present, this will be used to connect to the asset. If no existing asset_type exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the asset_type. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the asset_type. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** Connection to asset Nodes */
export type AssetConnection = {
  /** A list of edges (relational context) between RootQuery and connected asset Nodes */
  edges: Array<AssetConnectionEdge>;
  /** A list of connected asset Nodes */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: AssetConnectionPageInfo;
};

/** Edge between a Node and a connected asset */
export type AssetConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected asset Node */
  node: Asset;
};

/** Page Info on the connected AssetConnectionEdge */
export type AssetConnectionPageInfo = {
...
/** Set relationships between the asset to postFormats */
export type AssetPostFormatsInput = {
  /** If true, this will append the postFormat to existing related postFormats. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<AssetPostFormatsNodeInput>>>;
};

/** List of postFormats to connect the asset to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type AssetPostFormatsNodeInput = {
  /** The description of the postFormat. This field is used to set a description of the postFormat if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the postFormat. If present, this will be used to connect to the asset. If no existing postFormat exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
...
/** Connection between the Asset type and the asset type */
export type AssetToAssetConnection = AssetConnection & Connection & {
  __typename?: 'AssetToAssetConnection';
  /** Edges for the AssetToAssetConnection connection */
  edges: Array<AssetToAssetConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: AssetToAssetConnectionPageInfo;
};

/** An edge in a connection */
export type AssetToAssetConnectionEdge = AssetConnectionEdge & Edge & {
...
/** Page Info on the &quot;AssetToAssetConnection&quot; */
export type AssetToAssetConnectionPageInfo = AssetConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'AssetToAssetConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Asset type and the asset_type type */
export type AssetToAsset_TypeConnection = Connection & {
  __typename?: 'AssetToAsset_typeConnection';
  /** Edges for the AssetToAsset_typeConnection connection */
  edges: Array<AssetToAsset_TypeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset_Type>;
  /** Information about pagination in a connection. */
  pageInfo: AssetToAsset_TypeConnectionPageInfo;
};

/** An edge in a connection */
export type AssetToAsset_TypeConnectionEdge = AssetTypeConnectionEdge & Edge & {
  __typename?: 'AssetToAsset_typeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset_Type;
...
/** Page Info on the &quot;AssetToAsset_typeConnection&quot; */
export type AssetToAsset_TypeConnectionPageInfo = Asset_TypeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'AssetToAsset_typeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the AssetToAsset_typeConnection connection */
export type AssetToAsset_TypeConnectionWhereArgs = {
...
/** Connection between the Asset type and the asset type */
export type AssetToParentConnectionEdge = AssetConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'AssetToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
...
/** Connection between the Asset type and the postFormat type */
export type AssetToPostFormatConnection = Connection & PostFormatConnection & {
  __typename?: 'AssetToPostFormatConnection';
  /** Edges for the AssetToPostFormatConnection connection */
  edges: Array<AssetToPostFormatConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<PostFormat>;
  /** Information about pagination in a connection. */
  pageInfo: AssetToPostFormatConnectionPageInfo;
};

/** An edge in a connection */
export type AssetToPostFormatConnectionEdge = Edge & PostFormatConnectionEdge & {
  __typename?: 'AssetToPostFormatConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: PostFormat;
...
/** Page Info on the &quot;AssetToPostFormatConnection&quot; */
export type AssetToPostFormatConnectionPageInfo = PageInfo & PostFormatConnectionPageInfo & WpPageInfo & {
  __typename?: 'AssetToPostFormatConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the AssetToPostFormatConnection connection */
export type AssetToPostFormatConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Asset type and the asset type */
export type AssetToPreviewConnectionEdge = AssetConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'AssetToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Asset;
...
/** Connection between the Asset type and the TermNode type */
export type AssetToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'AssetToTermNodeConnection';
  /** Edges for the AssetToTermNodeConnection connection */
  edges: Array<AssetToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: AssetToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type AssetToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'AssetToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;AssetToTermNodeConnection&quot; */
export type AssetToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'AssetToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the AssetToTermNodeConnection connection */
export type AssetToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Edge between a Node and a connected asset_type */
export type AssetTypeConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected asset_type Node */
  node: Asset_Type;
};

/** Connection between the asset type and the nft type */
export type Asset_Asset_Nfts_Connection = Connection & NftConnection & {
  __typename?: 'Asset_asset_nfts_connection';
  /** Edges for the asset_asset_nfts_connection connection */
  edges: Array<Asset_Asset_Nfts_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Nft>;
  /** Information about pagination in a connection. */
  pageInfo: Asset_Asset_Nfts_ConnectionPageInfo;
};

/** An edge in a connection */
export type Asset_Asset_Nfts_ConnectionEdge = Edge & NftConnectionEdge & {
  __typename?: 'Asset_asset_nfts_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Nft;
...
/** Page Info on the &quot;asset_asset_nfts_connection&quot; */
export type Asset_Asset_Nfts_ConnectionPageInfo = NftConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Asset_asset_nfts_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The asset_type type */
export type Asset_Type = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Asset_type';
  /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<Asset_TypeToAncestorsAsset_TypeConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  asset_typeId?: Maybe<Scalars['Int']['output']>;
  /** Connection between the Asset_type type and the asset type */
  assets?: Maybe<Asset_TypeToAssetConnection>;
  /** Connection between the asset_type type and its children asset_types. */
  children?: Maybe<Asset_TypeToAsset_TypeConnection>;
  /** Connection between the Asset_type type and the ContentNode type */
  contentNodes?: Maybe<Asset_TypeToContentNodeConnection>;
  ...
  /** Connection between the asset_type type and its parent asset_type. */
  parent?: Maybe<Asset_TypeToParentAsset_TypeConnectionEdge>;
  ...
  slug?: Maybe<Scalars['String']['output']>;
  /** Connection between the Asset_type type and the Taxonomy type */
  taxonomy?: Maybe<Asset_TypeToTaxonomyConnectionEdge>;
...
/** The asset_type type */
export type Asset_TypeAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The asset_type type */
export type Asset_TypeAssetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Asset_TypeToAssetConnectionWhereArgs>;
};


/** The asset_type type */
export type Asset_TypeChildrenArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Asset_TypeToAsset_TypeConnectionWhereArgs>;
};


/** The asset_type type */
export type Asset_TypeContentNodesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Asset_TypeToContentNodeConnectionWhereArgs>;
};


/** The asset_type type */
export type Asset_TypeEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The asset_type type */
export type Asset_TypeEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Page Info on the connected AssetTypeConnectionEdge */
export type Asset_TypeConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Asset_type type and the asset_type type */
export type Asset_TypeToAncestorsAsset_TypeConnection = Connection & {
  __typename?: 'Asset_typeToAncestorsAsset_typeConnection';
  /** Edges for the Asset_typeToAncestorsAsset_typeConnection connection */
  edges: Array<Asset_TypeToAncestorsAsset_TypeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset_Type>;
  /** Information about pagination in a connection. */
  pageInfo: Asset_TypeToAncestorsAsset_TypeConnectionPageInfo;
};

/** An edge in a connection */
export type Asset_TypeToAncestorsAsset_TypeConnectionEdge = AssetTypeConnectionEdge & Edge & {
  __typename?: 'Asset_typeToAncestorsAsset_typeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset_Type;
...
/** Page Info on the &quot;Asset_typeToAncestorsAsset_typeConnection&quot; */
export type Asset_TypeToAncestorsAsset_TypeConnectionPageInfo = Asset_TypeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Asset_typeToAncestorsAsset_typeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Asset_type type and the asset type */
export type Asset_TypeToAssetConnection = AssetConnection & Connection & {
  __typename?: 'Asset_typeToAssetConnection';
  /** Edges for the Asset_typeToAssetConnection connection */
  edges: Array<Asset_TypeToAssetConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: Asset_TypeToAssetConnectionPageInfo;
};

/** An edge in a connection */
export type Asset_TypeToAssetConnectionEdge = AssetConnectionEdge & Edge & {
  __typename?: 'Asset_typeToAssetConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset;
...
/** Page Info on the &quot;Asset_typeToAssetConnection&quot; */
export type Asset_TypeToAssetConnectionPageInfo = AssetConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Asset_typeToAssetConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Asset_typeToAssetConnection connection */
export type Asset_TypeToAssetConnectionWhereArgs = {
...
/** Connection between the Asset_type type and the asset_type type */
export type Asset_TypeToAsset_TypeConnection = Connection & {
  __typename?: 'Asset_typeToAsset_typeConnection';
  /** Edges for the Asset_typeToAsset_typeConnection connection */
  edges: Array<Asset_TypeToAsset_TypeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset_Type>;
  /** Information about pagination in a connection. */
  pageInfo: Asset_TypeToAsset_TypeConnectionPageInfo;
};

/** An edge in a connection */
export type Asset_TypeToAsset_TypeConnectionEdge = AssetTypeConnectionEdge & Edge & {
  __typename?: 'Asset_typeToAsset_typeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset_Type;
...
/** Page Info on the &quot;Asset_typeToAsset_typeConnection&quot; */
export type Asset_TypeToAsset_TypeConnectionPageInfo = Asset_TypeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Asset_typeToAsset_typeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Asset_typeToAsset_typeConnection connection */
export type Asset_TypeToAsset_TypeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Asset_type type and the ContentNode type */
export type Asset_TypeToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'Asset_typeToContentNodeConnection';
  /** Edges for the Asset_typeToContentNodeConnection connection */
  edges: Array<Asset_TypeToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: Asset_TypeToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type Asset_TypeToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'Asset_typeToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Page Info on the &quot;Asset_typeToContentNodeConnection&quot; */
export type Asset_TypeToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Asset_typeToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Asset_typeToContentNodeConnection connection */
export type Asset_TypeToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfAssetTypeEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Asset_type type and the asset_type type */
export type Asset_TypeToParentAsset_TypeConnectionEdge = AssetTypeConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Asset_typeToParentAsset_typeConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Asset_Type;
...
/** Connection between the Asset_type type and the Taxonomy type */
export type Asset_TypeToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'Asset_typeToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']['output']>;
  /** Connection between the Category type and the custom_listing type */
  customListings?: Maybe<CategoryToCustom_ListingConnection>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  /** The description of the object */
  description?: Maybe<Scalars['String']['output']>;
...
/** The category type */
export type CategoryCustomListingsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CategoryToCustom_ListingConnectionWhereArgs>;
};
...
/** Connection between the Category type and the custom_listing type */
export type CategoryToCustom_ListingConnection = Connection & {
  __typename?: 'CategoryToCustom_listingConnection';
  /** Edges for the CategoryToCustom_listingConnection connection */
  edges: Array<CategoryToCustom_ListingConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToCustom_ListingConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToCustom_ListingConnectionEdge = CustomListingConnectionEdge & Edge & {
  __typename?: 'CategoryToCustom_listingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing;
...
/** Page Info on the &quot;CategoryToCustom_listingConnection&quot; */
export type CategoryToCustom_ListingConnectionPageInfo = Custom_ListingConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'CategoryToCustom_listingConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToCustom_listingConnection connection */
export type CategoryToCustom_ListingConnectionWhereArgs = {
  /** Category ID */
...
/** The challenge type */
export type Challenge = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Challenge';
  accountSize?: Maybe<Scalars['String']['output']>;
  /** Fields from the Additional Fields group in Pods */
  additionalFieldGroup?: Maybe<AdditionalFieldGroupConnection>;
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<ChallengeToChallengeConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  challengeId: Scalars['Int']['output'];
  /** Connection between the challenge type and the custom_listing type */
  challengeListing?: Maybe<Challenge_Challenge_Listing_ConnectionEdge>;
  commissionPerLotForex?: Maybe<Scalars['String']['output']>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the challenge object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the challenge object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** The permalink of the post */
  link?: Maybe<Scalars['String']['output']>;
  maxDailyLoss?: Maybe<Scalars['String']['output']>;
  maxDrawdown?: Maybe<Scalars['String']['output']>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']['output']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<ChallengeToParentConnectionEdge>;
  /** The password for the challenge object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Challenge type and the challenge type */
  preview?: Maybe<ChallengeToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  price?: Maybe<Scalars['String']['output']>;
  profitSplit?: Maybe<Scalars['String']['output']>;
  profitTarget?: Maybe<Scalars['String']['output']>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
...
/** The challenge type */
export type ChallengeAccountSizeArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengeAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The challenge type */
export type ChallengeCommissionPerLotForexArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};
...
/** The challenge type */
export type ChallengeEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The challenge type */
export type ChallengeEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The challenge type */
export type ChallengeMaxDailyLossArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengeMaxDrawdownArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengePriceArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengeProfitSplitArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengeProfitTargetArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The challenge type */
export type ChallengeTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to challenge Nodes */
export type ChallengeConnection = {
  /** A list of edges (relational context) between RootQuery and connected challenge Nodes */
  edges: Array<ChallengeConnectionEdge>;
  /** A list of connected challenge Nodes */
  nodes: Array<Challenge>;
  /** Information about pagination in a connection. */
  pageInfo: ChallengeConnectionPageInfo;
};

/** Edge between a Node and a connected challenge */
export type ChallengeConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected challenge Node */
  node: Challenge;
};

/** Page Info on the connected ChallengeConnectionEdge */
export type ChallengeConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Challenge type and the challenge type */
export type ChallengeToChallengeConnection = ChallengeConnection & Connection & {
  __typename?: 'ChallengeToChallengeConnection';
  /** Edges for the ChallengeToChallengeConnection connection */
  edges: Array<ChallengeToChallengeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Challenge>;
  /** Information about pagination in a connection. */
  pageInfo: ChallengeToChallengeConnectionPageInfo;
};

/** An edge in a connection */
export type ChallengeToChallengeConnectionEdge = ChallengeConnectionEdge & Edge & {
  __typename?: 'ChallengeToChallengeConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;ChallengeToChallengeConnection&quot; */
export type ChallengeToChallengeConnectionPageInfo = ChallengeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ChallengeToChallengeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Challenge type and the challenge type */
export type ChallengeToParentConnectionEdge = ChallengeConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'ChallengeToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Challenge type and the challenge type */
export type ChallengeToPreviewConnectionEdge = ChallengeConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'ChallengeToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Challenge;
...
/** Connection between the challenge type and the custom_listing type */
export type Challenge_Challenge_Listing_ConnectionEdge = CustomListingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Challenge_challenge_listing_connectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Custom_Listing;
...
/** Allowed Content Types of the AssetType taxonomy. */
export enum ContentTypesOfAssetTypeEnum {
  /** The Type of Content object */
  Asset = 'ASSET'
}
...
export type CreateAssetInput = {
  /** Set connections between the asset and asset_types */
  asset_types?: InputMaybe<AssetAsset_TypesInput>;
  ...
  password?: InputMaybe<Scalars['String']['input']>;
  /** Set connections between the asset and postFormats */
  postFormats?: InputMaybe<AssetPostFormatsInput>;
...
/** Input for the createAsset_type mutation. */
export type CreateAsset_TypeInput = {
  /** The slug that the asset_type will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the asset_type object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the asset_type object to mutate */
  name: Scalars['String']['input'];
  /** The ID of the asset_type that should be set as the parent */
  parentId?: InputMaybe<Scalars['ID']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createAsset_type mutation. */
export type CreateAsset_TypePayload = {
  __typename?: 'CreateAsset_typePayload';
  /** The created asset_type */
  asset_type?: Maybe<Asset_Type>;
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the createChallenge mutation. */
...
/** The payload for the createChallenge mutation. */
...
/** Input for the createCustom_listing mutation. */
export type CreateCustom_ListingInput = {
  /** Set connections between the custom_listing and categories */
  categories?: InputMaybe<Custom_ListingCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createCustom_listing mutation. */
export type CreateCustom_ListingPayload = {
  __typename?: 'CreateCustom_listingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  custom_listing?: Maybe<Custom_Listing>;
};

/** Input for the createCustom_listing_category mutation. */
export type CreateCustom_Listing_CategoryInput = {
  /** The slug that the custom_listing_category will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the custom_listing_category object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the custom_listing_category object to mutate */
  name: Scalars['String']['input'];
  /** The ID of the custom_listing_category that should be set as the parent */
  parentId?: InputMaybe<Scalars['ID']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createCustom_listing_category mutation. */
export type CreateCustom_Listing_CategoryPayload = {
  __typename?: 'CreateCustom_listing_categoryPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created custom_listing_category */
  custom_listing_category?: Maybe<Custom_Listing_Category>;
};
...
/** Input for the createNft mutation. */
...
/** The payload for the createNft mutation. */
export type CreateNftPayload = {
  __typename?: 'CreateNftPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  nft?: Maybe<Nft>;
...
/** Input for the createOffer mutation. */
...
/** The payload for the createOffer mutation. */
...
/** Edge between a Node and a connected custom_listing_category */
export type CustomListingCategoryConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected custom_listing_category Node */
  node: Custom_Listing_Category;
};

/** Edge between a Node and a connected custom_listing */
export type CustomListingConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected custom_listing Node */
  node: Custom_Listing;
};

/** The custom_listing type */
export type Custom_Listing = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Custom_listing';
  /** Fields from the Additional Fields group in Pods */
  additionalFieldGroup?: Maybe<AdditionalFieldGroupConnection>;
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<Custom_ListingToCustom_ListingConnection>;
  broker?: Maybe<Scalars['String']['output']>;
  /** Connection between the Custom_listing type and the category type */
  categories?: Maybe<Custom_ListingToCategoryConnection>;
  ceo?: Maybe<Scalars['String']['output']>;
  /** Connection between the custom_listing type and the challenge type */
  challenges?: Maybe<Custom_Listing_Challenges_Connection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  custom_listingId: Scalars['Int']['output'];
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  /** Post publishing date. */
  date?: Maybe<Scalars['String']['output']>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the custom_listing object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the custom_listing object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Connection between the custom_listing type and the nft type */
  nfts?: Maybe<Custom_Listing_Nfts_Connection>;
  /** Connection between the custom_listing type and the offer type */
  offers?: Maybe<Custom_Listing_Offers_Connection>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<Custom_ListingToParentConnectionEdge>;
  /** The password for the custom_listing object. */
  password?: Maybe<Scalars['String']['output']>;
  paymentMethods?: Maybe<Scalars['String']['output']>;
  payoutMethods?: Maybe<Scalars['String']['output']>;
  /** Connection between the Custom_listing type and the custom_listing type */
  preview?: Maybe<Custom_ListingToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  /** Connection between the custom_listing type and the review type */
  reviews?: Maybe<Custom_Listing_Reviews_Connection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
  /** The template assigned to the node */
  template?: Maybe<ContentTemplate>;
  /** Connection between the Custom_listing type and the TermNode type */
  terms?: Maybe<Custom_ListingToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']['output']>;
  tradingPlatforms?: Maybe<Scalars['String']['output']>;
  trustPilot?: Maybe<Scalars['String']['output']>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
};
...
/** The custom_listing type */
export type Custom_ListingAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingBrokerArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingCategoriesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Custom_ListingToCategoryConnectionWhereArgs>;
};


/** The custom_listing type */
export type Custom_ListingCeoArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingChallengesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingCountryArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingEstablishedArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingNftsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingOffersArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingPaymentMethodsArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingPayoutMethodsArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingReviewsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing type */
export type Custom_ListingTermsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Custom_ListingToTermNodeConnectionWhereArgs>;
};


/** The custom_listing type */
export type Custom_ListingTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingTradingPlatformsArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The custom_listing type */
export type Custom_ListingTrustPilotArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Set relationships between the custom_listing to categories */
export type Custom_ListingCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<Custom_ListingCategoriesNodeInput>>>;
};

/** List of categories to connect the custom_listing to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type Custom_ListingCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the custom_listing. If no existing category exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
...
/** Page Info on the connected CustomListingConnectionEdge */
export type Custom_ListingConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum Custom_ListingIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId123 = 'DATABASE_ID123',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the Custom_listing type and the category type */
export type Custom_ListingToCategoryConnection = CategoryConnection & Connection & {
  __typename?: 'Custom_listingToCategoryConnection';
  /** Edges for the Custom_listingToCategoryConnection connection */
  edges: Array<Custom_ListingToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_ListingToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_ListingToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  __typename?: 'Custom_listingToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Category;
...
/** Page Info on the &quot;Custom_listingToCategoryConnection&quot; */
export type Custom_ListingToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listingToCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Custom_listingToCategoryConnection connection */
export type Custom_ListingToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Custom_listing type and the custom_listing type */
export type Custom_ListingToCustom_ListingConnection = Connection & {
  __typename?: 'Custom_listingToCustom_listingConnection';
  /** Edges for the Custom_listingToCustom_listingConnection connection */
  edges: Array<Custom_ListingToCustom_ListingConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_ListingToCustom_ListingConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_ListingToCustom_ListingConnectionEdge = CustomListingConnectionEdge & Edge & {
  __typename?: 'Custom_listingToCustom_listingConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;Custom_listingToCustom_listingConnection&quot; */
export type Custom_ListingToCustom_ListingConnectionPageInfo = Custom_ListingConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listingToCustom_listingConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Custom_listing type and the custom_listing type */
export type Custom_ListingToParentConnectionEdge = CustomListingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Custom_listingToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Custom_listing type and the custom_listing type */
export type Custom_ListingToPreviewConnectionEdge = CustomListingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Custom_listingToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Custom_Listing;
...
/** Connection between the Custom_listing type and the TermNode type */
export type Custom_ListingToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'Custom_listingToTermNodeConnection';
  /** Edges for the Custom_listingToTermNodeConnection connection */
  edges: Array<Custom_ListingToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_ListingToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_ListingToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'Custom_listingToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;Custom_listingToTermNodeConnection&quot; */
export type Custom_ListingToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'Custom_listingToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Custom_listingToTermNodeConnection connection */
export type Custom_ListingToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing_category type */
export type Custom_Listing_Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Custom_listing_category';
  /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnection>;
  /** Connection between the custom_listing_category type and its children custom_listing_categories. */
  children?: Maybe<Custom_Listing_CategoryToCustom_Listing_CategoryConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']['output']>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  custom_listing_categoryId?: Maybe<Scalars['Int']['output']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  /** The description of the object */
  description?: Maybe<Scalars['String']['output']>;
  ...
  /** The human friendly name of the object. */
  name?: Maybe<Scalars['String']['output']>;
  /** Connection between the custom_listing_category type and its parent custom_listing_category. */
  parent?: Maybe<Custom_Listing_CategoryToParentCustom_Listing_CategoryConnectionEdge>;
  /** Database id of the parent node */
  parentDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** The globally unique identifier of the parent node. */
  parentId?: Maybe<Scalars['ID']['output']>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']['output']>;
  /** Connection between the Custom_listing_category type and the Taxonomy type */
  taxonomy?: Maybe<Custom_Listing_CategoryToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']['output']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']['output']>;
...
/** The custom_listing_category type */
export type Custom_Listing_CategoryAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing_category type */
export type Custom_Listing_CategoryChildrenArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Custom_Listing_CategoryToCustom_Listing_CategoryConnectionWhereArgs>;
};


/** The custom_listing_category type */
export type Custom_Listing_CategoryEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The custom_listing_category type */
export type Custom_Listing_CategoryEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Page Info on the connected CustomListingCategoryConnectionEdge */
export type Custom_Listing_CategoryConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum Custom_Listing_CategoryIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the Custom_listing_category type and the custom_listing_category type */
export type Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnection = Connection & {
  __typename?: 'Custom_listing_categoryToAncestorsCustom_listing_categoryConnection';
  /** Edges for the Custom_listing_categoryToAncestorsCustom_listing_categoryConnection connection */
  edges: Array<Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing_Category>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnectionEdge = CustomListingCategoryConnectionEdge & Edge & {
  __typename?: 'Custom_listing_categoryToAncestorsCustom_listing_categoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing_Category;
...
/** Page Info on the &quot;Custom_listing_categoryToAncestorsCustom_listing_categoryConnection&quot; */
export type Custom_Listing_CategoryToAncestorsCustom_Listing_CategoryConnectionPageInfo = Custom_Listing_CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_categoryToAncestorsCustom_listing_categoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Custom_listing_category type and the custom_listing_category type */
export type Custom_Listing_CategoryToCustom_Listing_CategoryConnection = Connection & {
  __typename?: 'Custom_listing_categoryToCustom_listing_categoryConnection';
  /** Edges for the Custom_listing_categoryToCustom_listing_categoryConnection connection */
  edges: Array<Custom_Listing_CategoryToCustom_Listing_CategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing_Category>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_CategoryToCustom_Listing_CategoryConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_CategoryToCustom_Listing_CategoryConnectionEdge = CustomListingCategoryConnectionEdge & Edge & {
  __typename?: 'Custom_listing_categoryToCustom_listing_categoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing_Category;
...
/** Page Info on the &quot;Custom_listing_categoryToCustom_listing_categoryConnection&quot; */
export type Custom_Listing_CategoryToCustom_Listing_CategoryConnectionPageInfo = Custom_Listing_CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_categoryToCustom_listing_categoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Custom_listing_categoryToCustom_listing_categoryConnection connection */
export type Custom_Listing_CategoryToCustom_Listing_CategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Custom_listing_category type and the custom_listing_category type */
export type Custom_Listing_CategoryToParentCustom_Listing_CategoryConnectionEdge = CustomListingCategoryConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Custom_listing_categoryToParentCustom_listing_categoryConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Custom_Listing_Category;
...
/** Connection between the Custom_listing_category type and the Taxonomy type */
export type Custom_Listing_CategoryToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'Custom_listing_categoryToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
/** Connection between the custom_listing type and the challenge type */
export type Custom_Listing_Challenges_Connection = ChallengeConnection & Connection & {
  __typename?: 'Custom_listing_challenges_connection';
  /** Edges for the custom_listing_challenges_connection connection */
  edges: Array<Custom_Listing_Challenges_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Challenge>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_Challenges_ConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_Challenges_ConnectionEdge = ChallengeConnectionEdge & Edge & {
  __typename?: 'Custom_listing_challenges_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Challenge;
...
/** Page Info on the &quot;custom_listing_challenges_connection&quot; */
export type Custom_Listing_Challenges_ConnectionPageInfo = ChallengeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_challenges_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the custom_listing type and the nft type */
export type Custom_Listing_Nfts_Connection = Connection & NftConnection & {
  __typename?: 'Custom_listing_nfts_connection';
  /** Edges for the custom_listing_nfts_connection connection */
  edges: Array<Custom_Listing_Nfts_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Nft>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_Nfts_ConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_Nfts_ConnectionEdge = Edge & NftConnectionEdge & {
  __typename?: 'Custom_listing_nfts_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Nft;
...
/** Page Info on the &quot;custom_listing_nfts_connection&quot; */
export type Custom_Listing_Nfts_ConnectionPageInfo = NftConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_nfts_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the custom_listing type and the offer type */
export type Custom_Listing_Offers_Connection = Connection & OfferConnection & {
  __typename?: 'Custom_listing_offers_connection';
  /** Edges for the custom_listing_offers_connection connection */
  edges: Array<Custom_Listing_Offers_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Offer>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_Offers_ConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_Offers_ConnectionEdge = Edge & OfferConnectionEdge & {
  __typename?: 'Custom_listing_offers_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Offer;
...
/** Page Info on the &quot;custom_listing_offers_connection&quot; */
export type Custom_Listing_Offers_ConnectionPageInfo = OfferConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_offers_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the custom_listing type and the review type */
export type Custom_Listing_Reviews_Connection = Connection & ReviewConnection & {
  __typename?: 'Custom_listing_reviews_connection';
  /** Edges for the custom_listing_reviews_connection connection */
  edges: Array<Custom_Listing_Reviews_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Review>;
  /** Information about pagination in a connection. */
  pageInfo: Custom_Listing_Reviews_ConnectionPageInfo;
};

/** An edge in a connection */
export type Custom_Listing_Reviews_ConnectionEdge = Edge & ReviewConnectionEdge & {
  __typename?: 'Custom_listing_reviews_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Review;
...
/** Page Info on the &quot;custom_listing_reviews_connection&quot; */
export type Custom_Listing_Reviews_ConnectionPageInfo = PageInfo & ReviewConnectionPageInfo & WpPageInfo & {
  __typename?: 'Custom_listing_reviews_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The template assigned to the node */
export type DashboardTemplate = ContentTemplate & {
  __typename?: 'DashboardTemplate';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the deleteAsset_type mutation. */
export type DeleteAsset_TypeInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the asset_type to delete */
  id: Scalars['ID']['input'];
};

/** The payload for the deleteAsset_type mutation. */
export type DeleteAsset_TypePayload = {
  __typename?: 'DeleteAsset_typePayload';
...
/** Input for the deleteChallenge mutation. */
...
/** The payload for the deleteChallenge mutation. */
...
/** Input for the deleteCustom_listing mutation. */
export type DeleteCustom_ListingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the custom_listing to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteCustom_listing mutation. */
export type DeleteCustom_ListingPayload = {
  __typename?: 'DeleteCustom_listingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The object before it was deleted */
  custom_listing?: Maybe<Custom_Listing>;
...
/** Input for the deleteCustom_listing_category mutation. */
export type DeleteCustom_Listing_CategoryInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the custom_listing_category to delete */
  id: Scalars['ID']['input'];
};

/** The payload for the deleteCustom_listing_category mutation. */
export type DeleteCustom_Listing_CategoryPayload = {
  __typename?: 'DeleteCustom_listing_categoryPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The deleted term object */
  custom_listing_category?: Maybe<Custom_Listing_Category>;
...
/** Input for the deleteNft mutation. */
export type DeleteNftInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the nft to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteNft mutation. */
export type DeleteNftPayload = {
  __typename?: 'DeleteNftPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Input for the deleteOffer mutation. */
...
/** The payload for the deleteOffer mutation. */
...
/** The template assigned to the node */
export type ListingsTemplate = ContentTemplate & {
  __typename?: 'ListingsTemplate';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
export enum MediaItemSizeEnum {
  /** MediaItem with the guido-gallery-large size */
  GuidoGalleryLarge = 'GUIDO_GALLERY_LARGE',
  /** MediaItem with the guido-gallery-medium size */
  GuidoGalleryMedium = 'GUIDO_GALLERY_MEDIUM',
  /** MediaItem with the guido-gallery-xl size */
  GuidoGalleryXl = 'GUIDO_GALLERY_XL',
  /** MediaItem with the guido-listing-grid size */
  GuidoListingGrid = 'GUIDO_LISTING_GRID',
  /** MediaItem with the guido-listing-list size */
  GuidoListingList = 'GUIDO_LISTING_LIST',
...
export type MenuItemObjectUnion = Asset | Asset_Type | Category | Challenge | Custom_Listing | Custom_Listing_Category | Offer | Page | Post | PostFormat | Review | Tag;
...
export enum MenuLocationEnum {
  /** Put the menu in the mobile-primary location */
  MobilePrimary = 'MOBILE_PRIMARY',
  /** Put the menu in the primary location */
  Primary = 'PRIMARY',
  /** Put the menu in the user-menu location */
  UserMenu = 'USER_MENU'
}
...
/** The nft type */
export type Nft = ContentNode & DatabaseIdentifier & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Nft';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<NftToNftConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the nft object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the nft object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** Connection between the nft type and the asset type */
  nftAssets?: Maybe<Nft_Nft_Assets_Connection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  nftId: Scalars['Int']['output'];
  nftLinks?: Maybe<Scalars['String']['output']>;
  /** Connection between the nft type and the custom_listing type */
  nftListings?: Maybe<Nft_Nft_Listings_Connection>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<NftToParentConnectionEdge>;
  /** The password for the nft object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Nft type and the nft type */
  preview?: Maybe<NftToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The nft type */
export type NftContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The nft type */
export type NftEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The nft type */
export type NftEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The nft type */
export type NftExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The nft type */
export type NftNftAddressArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The nft type */
export type NftNftAssetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The nft type */
export type NftNftLinksArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The nft type */
export type NftNftListingsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The nft type */
export type NftTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to nft Nodes */
export type NftConnection = {
  /** A list of edges (relational context) between RootQuery and connected nft Nodes */
  edges: Array<NftConnectionEdge>;
  /** A list of connected nft Nodes */
  nodes: Array<Nft>;
  /** Information about pagination in a connection. */
  pageInfo: NftConnectionPageInfo;
};

/** Edge between a Node and a connected nft */
export type NftConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected nft Node */
  node: Nft;
};

/** Page Info on the connected NftConnectionEdge */
export type NftConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Nft type and the nft type */
export type NftToNftConnection = Connection & NftConnection & {
  __typename?: 'NftToNftConnection';
  /** Edges for the NftToNftConnection connection */
  edges: Array<NftToNftConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Nft>;
  /** Information about pagination in a connection. */
  pageInfo: NftToNftConnectionPageInfo;
};

/** An edge in a connection */
export type NftToNftConnectionEdge = Edge & NftConnectionEdge & {
  __typename?: 'NftToNftConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;NftToNftConnection&quot; */
export type NftToNftConnectionPageInfo = NftConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'NftToNftConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Nft type and the nft type */
export type NftToParentConnectionEdge = Edge & NftConnectionEdge & OneToOneConnection & {
  __typename?: 'NftToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Nft type and the nft type */
export type NftToPreviewConnectionEdge = Edge & NftConnectionEdge & OneToOneConnection & {
  __typename?: 'NftToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Nft;
...
/** Connection between the nft type and the asset type */
export type Nft_Nft_Assets_Connection = AssetConnection & Connection & {
  __typename?: 'Nft_nft_assets_connection';
  /** Edges for the nft_nft_assets_connection connection */
  edges: Array<Nft_Nft_Assets_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: Nft_Nft_Assets_ConnectionPageInfo;
};

/** An edge in a connection */
export type Nft_Nft_Assets_ConnectionEdge = AssetConnectionEdge & Edge & {
  __typename?: 'Nft_nft_assets_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset;
...
/** Page Info on the &quot;nft_nft_assets_connection&quot; */
export type Nft_Nft_Assets_ConnectionPageInfo = AssetConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Nft_nft_assets_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the nft type and the custom_listing type */
export type Nft_Nft_Listings_Connection = Connection & {
  __typename?: 'Nft_nft_listings_connection';
  /** Edges for the nft_nft_listings_connection connection */
  edges: Array<Nft_Nft_Listings_ConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing>;
  /** Information about pagination in a connection. */
  pageInfo: Nft_Nft_Listings_ConnectionPageInfo;
};

/** An edge in a connection */
export type Nft_Nft_Listings_ConnectionEdge = CustomListingConnectionEdge & Edge & {
  __typename?: 'Nft_nft_listings_connectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing;
...
/** Page Info on the &quot;nft_nft_listings_connection&quot; */
export type Nft_Nft_Listings_ConnectionPageInfo = Custom_ListingConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Nft_nft_listings_connectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The offer type */
export type Offer = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Offer';
  /** Fields from the Additional Fields group in Pods */
  additionalFieldGroup?: Maybe<AdditionalFieldGroupConnection>;
  /**
   ...
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<OfferToOfferConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the offer object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the offer object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** Connection between the offer type and the custom_listing type */
  offerListing?: Maybe<Offer_Offer_Listing_ConnectionEdge>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<OfferToParentConnectionEdge>;
  /** The password for the offer object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Offer type and the offer type */
  preview?: Maybe<OfferToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The offer type */
export type OfferAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The offer type */
export type OfferContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The offer type */
export type OfferEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The offer type */
export type OfferEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The offer type */
export type OfferExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The offer type */
export type OfferOfferLinkArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The offer type */
export type OfferTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to offer Nodes */
export type OfferConnection = {
  /** A list of edges (relational context) between RootQuery and connected offer Nodes */
  edges: Array<OfferConnectionEdge>;
  /** A list of connected offer Nodes */
  nodes: Array<Offer>;
  /** Information about pagination in a connection. */
  pageInfo: OfferConnectionPageInfo;
};

/** Edge between a Node and a connected offer */
export type OfferConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected offer Node */
  node: Offer;
};

/** Page Info on the connected OfferConnectionEdge */
export type OfferConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Offer type and the offer type */
export type OfferToOfferConnection = Connection & OfferConnection & {
  __typename?: 'OfferToOfferConnection';
  /** Edges for the OfferToOfferConnection connection */
  edges: Array<OfferToOfferConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Offer>;
  /** Information about pagination in a connection. */
  pageInfo: OfferToOfferConnectionPageInfo;
};

/** An edge in a connection */
export type OfferToOfferConnectionEdge = Edge & OfferConnectionEdge & {
  __typename?: 'OfferToOfferConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;OfferToOfferConnection&quot; */
export type OfferToOfferConnectionPageInfo = OfferConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'OfferToOfferConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Offer type and the offer type */
export type OfferToParentConnectionEdge = Edge & OfferConnectionEdge & OneToOneConnection & {
  __typename?: 'OfferToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Offer type and the offer type */
export type OfferToPreviewConnectionEdge = Edge & OfferConnectionEdge & OneToOneConnection & {
  __typename?: 'OfferToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Offer;
...
/** Connection between the offer type and the custom_listing type */
export type Offer_Offer_Listing_ConnectionEdge = CustomListingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Offer_offer_listing_connectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Custom_Listing;
...
export type PostFormat = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  /** Connection between the PostFormat type and the asset type */
  assets?: Maybe<PostFormatToAssetConnection>;
...
/** The postFormat type */
export type PostFormatAssetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PostFormatToAssetConnectionWhereArgs>;
};
...
/** Connection between the PostFormat type and the asset type */
export type PostFormatToAssetConnection = AssetConnection & Connection & {
  __typename?: 'PostFormatToAssetConnection';
  /** Edges for the PostFormatToAssetConnection connection */
  edges: Array<PostFormatToAssetConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: PostFormatToAssetConnectionPageInfo;
};

/** An edge in a connection */
export type PostFormatToAssetConnectionEdge = AssetConnectionEdge & Edge & {
  __typename?: 'PostFormatToAssetConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset;
...
/** Page Info on the &quot;PostFormatToAssetConnection&quot; */
export type PostFormatToAssetConnectionPageInfo = AssetConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'PostFormatToAssetConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PostFormatToAssetConnection connection */
export type PostFormatToAssetConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** The review type */
export type Review = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Review';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** The permalink of the post */
  link?: Maybe<Scalars['String']['output']>;
  /** Connection between the review type and the custom_listing type */
  listing?: Maybe<Review_Listing_ConnectionEdge>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']['output']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
...
/** Connection between the review type and the custom_listing type */
export type Review_Listing_ConnectionEdge = CustomListingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'Review_listing_connectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Custom_Listing;
...
export type RootMutation = {
  ...
  /** The createAsset mutation */
  createAsset?: Maybe<CreateAssetPayload>;
  /** The createAsset_type mutation */
  createAsset_type?: Maybe<CreateAsset_TypePayload>;
  /** The createCategory mutation */
  createCategory?: Maybe<CreateCategoryPayload>;
  /** The createChallenge mutation */
  createChallenge?: Maybe<CreateChallengePayload>;
  /** The createComment mutation */
  createComment?: Maybe<CreateCommentPayload>;
  /** The createCustom_listing mutation */
  createCustom_listing?: Maybe<CreateCustom_ListingPayload>;
  /** The createCustom_listing_category mutation */
  createCustom_listing_category?: Maybe<CreateCustom_Listing_CategoryPayload>;
  /** The createMediaItem mutation */
  createMediaItem?: Maybe<CreateMediaItemPayload>;
  /** The createNft mutation */
  createNft?: Maybe<CreateNftPayload>;
  /** The createOffer mutation */
  ...
  /** The deleteAsset mutation */
  deleteAsset?: Maybe<DeleteAssetPayload>;
  /** The deleteAsset_type mutation */
  deleteAsset_type?: Maybe<DeleteAsset_TypePayload>;
  /** The deleteCategory mutation */
  deleteCategory?: Maybe<DeleteCategoryPayload>;
  /** The deleteChallenge mutation */
  deleteChallenge?: Maybe<DeleteChallengePayload>;
  /** The deleteComment mutation */
  deleteComment?: Maybe<DeleteCommentPayload>;
  /** The deleteCustom_listing mutation */
  deleteCustom_listing?: Maybe<DeleteCustom_ListingPayload>;
  /** The deleteCustom_listing_category mutation */
  deleteCustom_listing_category?: Maybe<DeleteCustom_Listing_CategoryPayload>;
  /** The deleteMediaItem mutation */
  deleteMediaItem?: Maybe<DeleteMediaItemPayload>;
  /** The deleteNft mutation */
  deleteNft?: Maybe<DeleteNftPayload>;
  /** The deleteOffer mutation */
  ...
  /** The updateAsset mutation */
  updateAsset?: Maybe<UpdateAssetPayload>;
  /** The updateAsset_type mutation */
  updateAsset_type?: Maybe<UpdateAsset_TypePayload>;
  /** The updateCategory mutation */
  updateCategory?: Maybe<UpdateCategoryPayload>;
  /** The updateChallenge mutation */
  updateChallenge?: Maybe<UpdateChallengePayload>;
  /** The updateComment mutation */
  updateComment?: Maybe<UpdateCommentPayload>;
  /** The updateCustom_listing mutation */
  updateCustom_listing?: Maybe<UpdateCustom_ListingPayload>;
  /** The updateCustom_listing_category mutation */
  updateCustom_listing_category?: Maybe<UpdateCustom_Listing_CategoryPayload>;
  /** The updateMediaItem mutation */
  updateMediaItem?: Maybe<UpdateMediaItemPayload>;
  /** The updateNft mutation */
  updateNft?: Maybe<UpdateNftPayload>;
  /** The updateOffer mutation */
...
/** The root mutation */
export type RootMutationCreateAsset_TypeArgs = {
  input: CreateAsset_TypeInput;
};
...
/** The root mutation */
export type RootMutationCreateChallengeArgs = {
...
/** The root mutation */
export type RootMutationCreateCustom_ListingArgs = {
  input: CreateCustom_ListingInput;
};


/** The root mutation */
export type RootMutationCreateCustom_Listing_CategoryArgs = {
  input: CreateCustom_Listing_CategoryInput;
};
...
/** The root mutation */
export type RootMutationCreateNftArgs = {
  input: CreateNftInput;
};


/** The root mutation */
export type RootMutationCreateOfferArgs = {
...
/** The root mutation */
export type RootMutationDeleteAsset_TypeArgs = {
  input: DeleteAsset_TypeInput;
};
...
/** The root mutation */
export type RootMutationDeleteChallengeArgs = {
...
/** The root mutation */
export type RootMutationDeleteCustom_ListingArgs = {
  input: DeleteCustom_ListingInput;
};


/** The root mutation */
export type RootMutationDeleteCustom_Listing_CategoryArgs = {
  input: DeleteCustom_Listing_CategoryInput;
};
...
/** The root mutation */
export type RootMutationDeleteNftArgs = {
  input: DeleteNftInput;
};


/** The root mutation */
export type RootMutationDeleteOfferArgs = {
...
/** The root mutation */
export type RootMutationUpdateAsset_TypeArgs = {
  input: UpdateAsset_TypeInput;
};
...
/** The root mutation */
export type RootMutationUpdateChallengeArgs = {
...
/** The root mutation */
export type RootMutationUpdateCustom_ListingArgs = {
  input: UpdateCustom_ListingInput;
};


/** The root mutation */
export type RootMutationUpdateCustom_Listing_CategoryArgs = {
  input: UpdateCustom_Listing_CategoryInput;
};
...
/** The root mutation */
export type RootMutationUpdateNftArgs = {
  input: UpdateNftInput;
};


/** The root mutation */
export type RootMutationUpdateOfferArgs = {
...
export type RootQuery = {
  ...
  assetBy?: Maybe<Asset>;
  /** A 0bject */
  assetType?: Maybe<Asset_Type>;
  /** Connection between the RootQuery type and the asset_type type */
  assetTypes?: Maybe<RootQueryToAsset_TypeConnection>;
  ...
  /** A 0bject */
  category?: Maybe<Category>;
  /** An object of the challenge Type.  */
  challenge?: Maybe<Challenge>;
  /**
   * A challenge object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  challengeBy?: Maybe<Challenge>;
  /** Connection between the RootQuery type and the challenge type */
  challenges?: Maybe<RootQueryToChallengeConnection>;
  /** Returns a Comment */
  comment?: Maybe<Comment>;
  ...
  /** An object of the custom_listing Type.  */
  customListing?: Maybe<Custom_Listing>;
  /**
   * A custom_listing object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  customListingBy?: Maybe<Custom_Listing>;
  /** Connection between the RootQuery type and the custom_listing_category type */
  customListingCategories?: Maybe<RootQueryToCustom_Listing_CategoryConnection>;
  /** A 0bject */
  customListingCategory?: Maybe<Custom_Listing_Category>;
  /** Connection between the RootQuery type and the custom_listing type */
  customListings?: Maybe<RootQueryToCustom_ListingConnection>;
   ...
   */
  nftBy?: Maybe<Nft>;
  /** Query an NFT by its NFT Address. */
  nftByAddress?: Maybe<Nft>;
  /** Connection between the RootQuery type and the nft type */
  nfts?: Maybe<RootQueryToNftConnection>;
  /** Fetches an object given its ID */
  node?: Maybe<Node>;
  /** Fetches an object given its Unique Resource Identifier */
  nodeByUri?: Maybe<UniformResourceIdentifiable>;
  /** An object of the offer Type.  */
  offer?: Maybe<Offer>;
  /**
   * A offer object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  offerBy?: Maybe<Offer>;
  /** Connection between the RootQuery type and the offer type */
  offers?: Maybe<RootQueryToOfferConnection>;
...
/** The root entry point into the Graph */
export type RootQueryAssetByArgs = {
...
/** The root entry point into the Graph */
export type RootQueryAssetTypeArgs = {
  id: Scalars['ID']['input'];
  idType?: InputMaybe<Asset_TypeIdType>;
};


/** The root entry point into the Graph */
export type RootQueryAssetTypesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToAsset_TypeConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryChallengeArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<ChallengeIdType>;
};


/** The root entry point into the Graph */
export type RootQueryChallengeByArgs = {
...
/** The root entry point into the Graph */
export type RootQueryChallengesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToChallengeConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryCustomListingArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<Custom_ListingIdType>;
};


/** The root entry point into the Graph */
export type RootQueryCustomListingByArgs = {
  custom_listingId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryCustomListingCategoriesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToCustom_Listing_CategoryConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryCustomListingCategoryArgs = {
  id: Scalars['ID']['input'];
  idType?: InputMaybe<Custom_Listing_CategoryIdType>;
};


/** The root entry point into the Graph */
export type RootQueryCustomListingsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToCustom_ListingConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryNftArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<NftIdType>;
};


/** The root entry point into the Graph */
export type RootQueryNftByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryNftByAddressArgs = {
  nftAddress?: InputMaybe<Scalars['String']['input']>;
};


/** The root entry point into the Graph */
export type RootQueryNftsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToNftConnectionWhereArgs>;
};
...
export type RootQueryOfferArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<OfferIdType>;
};


/** The root entry point into the Graph */
export type RootQueryOfferByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
...
export type RootQueryOffersArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToOfferConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the asset type */
export type RootQueryToAssetConnection = AssetConnection & Connection & {
  __typename?: 'RootQueryToAssetConnection';
  /** Edges for the RootQueryToAssetConnection connection */
  edges: Array<RootQueryToAssetConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToAssetConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToAssetConnectionEdge = AssetConnectionEdge & Edge & {
...
/** Page Info on the &quot;RootQueryToAssetConnection&quot; */
export type RootQueryToAssetConnectionPageInfo = AssetConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToAssetConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type RootQueryToAssetConnectionWhereArgs = {
  ...
  password?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the post object to filter by */
  postFormat?: InputMaybe<Scalars['String']['input']>;
  /** Show Posts based on a keyword search */
  search?: InputMaybe<Scalars['String']['input']>;
  /** Retrieve posts where post status is in an array. */
  stati?: InputMaybe<Array<InputMaybe<PostStatusEnum>>>;
...
/** Connection between the RootQuery type and the asset_type type */
export type RootQueryToAsset_TypeConnection = Connection & {
  __typename?: 'RootQueryToAsset_typeConnection';
  /** Edges for the RootQueryToAsset_typeConnection connection */
  edges: Array<RootQueryToAsset_TypeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Asset_Type>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToAsset_TypeConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToAsset_TypeConnectionEdge = AssetTypeConnectionEdge & Edge & {
  __typename?: 'RootQueryToAsset_typeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Asset_Type;
...
/** Page Info on the &quot;RootQueryToAsset_typeConnection&quot; */
export type RootQueryToAsset_TypeConnectionPageInfo = Asset_TypeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToAsset_typeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToAsset_typeConnection connection */
export type RootQueryToAsset_TypeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the RootQuery type and the challenge type */
export type RootQueryToChallengeConnection = ChallengeConnection & Connection & {
  __typename?: 'RootQueryToChallengeConnection';
  /** Edges for the RootQueryToChallengeConnection connection */
  edges: Array<RootQueryToChallengeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Challenge>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToChallengeConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToChallengeConnectionEdge = ChallengeConnectionEdge & Edge & {
  __typename?: 'RootQueryToChallengeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Challenge;
...
/** Page Info on the &quot;RootQueryToChallengeConnection&quot; */
export type RootQueryToChallengeConnectionPageInfo = ChallengeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToChallengeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToChallengeConnection connection */
export type RootQueryToChallengeConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the custom_listing type */
export type RootQueryToCustom_ListingConnection = Connection & {
  __typename?: 'RootQueryToCustom_listingConnection';
  /** Edges for the RootQueryToCustom_listingConnection connection */
  edges: Array<RootQueryToCustom_ListingConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToCustom_ListingConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToCustom_ListingConnectionEdge = CustomListingConnectionEdge & Edge & {
  __typename?: 'RootQueryToCustom_listingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing;
...
/** Page Info on the &quot;RootQueryToCustom_listingConnection&quot; */
export type RootQueryToCustom_ListingConnectionPageInfo = Custom_ListingConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToCustom_listingConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToCustom_listingConnection connection */
export type RootQueryToCustom_ListingConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the RootQuery type and the custom_listing_category type */
export type RootQueryToCustom_Listing_CategoryConnection = Connection & {
  __typename?: 'RootQueryToCustom_listing_categoryConnection';
  /** Edges for the RootQueryToCustom_listing_categoryConnection connection */
  edges: Array<RootQueryToCustom_Listing_CategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Custom_Listing_Category>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToCustom_Listing_CategoryConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToCustom_Listing_CategoryConnectionEdge = CustomListingCategoryConnectionEdge & Edge & {
  __typename?: 'RootQueryToCustom_listing_categoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Custom_Listing_Category;
...
/** Page Info on the &quot;RootQueryToCustom_listing_categoryConnection&quot; */
export type RootQueryToCustom_Listing_CategoryConnectionPageInfo = Custom_Listing_CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToCustom_listing_categoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToCustom_listing_categoryConnection connection */
export type RootQueryToCustom_Listing_CategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the RootQuery type and the nft type */
export type RootQueryToNftConnection = Connection & NftConnection & {
  __typename?: 'RootQueryToNftConnection';
  /** Edges for the RootQueryToNftConnection connection */
  edges: Array<RootQueryToNftConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Nft>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToNftConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToNftConnectionEdge = Edge & NftConnectionEdge & {
  __typename?: 'RootQueryToNftConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Nft;
...
/** Page Info on the &quot;RootQueryToNftConnection&quot; */
export type RootQueryToNftConnectionPageInfo = NftConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToNftConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToNftConnection connection */
export type RootQueryToNftConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the offer type */
export type RootQueryToOfferConnection = Connection & OfferConnection & {
  __typename?: 'RootQueryToOfferConnection';
  /** Edges for the RootQueryToOfferConnection connection */
  edges: Array<RootQueryToOfferConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Offer>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToOfferConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToOfferConnectionEdge = Edge & OfferConnectionEdge & {
  __typename?: 'RootQueryToOfferConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Offer;
...
/** Page Info on the &quot;RootQueryToOfferConnection&quot; */
export type RootQueryToOfferConnectionPageInfo = OfferConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToOfferConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToOfferConnection connection */
export type RootQueryToOfferConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
export enum TaxonomyEnum {
  /** Taxonomy enum asset_type */
  AssetType = 'ASSET_TYPE',
  /** Taxonomy enum category */
  Category = 'CATEGORY',
  /** Taxonomy enum custom_listing_category */
  CustomListingCategory = 'CUSTOM_LISTING_CATEGORY',
...
/** The template assigned to the node */
export type Template_404Page = ContentTemplate & {
  __typename?: 'Template_404Page';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the updateAsset_type mutation. */
export type UpdateAsset_TypeInput = {
  /** The slug that the asset_type will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the asset_type object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the asset_type object to update */
  id: Scalars['ID']['input'];
  /** The name of the asset_type object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the asset_type that should be set as the parent */
...
/** The payload for the updateAsset_type mutation. */
export type UpdateAsset_TypePayload = {
  __typename?: 'UpdateAsset_typePayload';
  /** The created asset_type */
  asset_type?: Maybe<Asset_Type>;
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the updateChallenge mutation. */
export type UpdateChallengeInput = {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the challenge object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateChallenge mutation. */
...
/** Input for the updateCustom_listing mutation. */
export type UpdateCustom_ListingInput = {
  /** Set connections between the custom_listing and categories */
  categories?: InputMaybe<Custom_ListingCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the custom_listing object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateCustom_listing mutation. */
export type UpdateCustom_ListingPayload = {
  __typename?: 'UpdateCustom_listingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  custom_listing?: Maybe<Custom_Listing>;
...
/** Input for the updateCustom_listing_category mutation. */
export type UpdateCustom_Listing_CategoryInput = {
  /** The slug that the custom_listing_category will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the custom_listing_category object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the custom_listing_category object to update */
  id: Scalars['ID']['input'];
  /** The name of the custom_listing_category object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the custom_listing_category that should be set as the parent */
...
/** The payload for the updateCustom_listing_category mutation. */
export type UpdateCustom_Listing_CategoryPayload = {
  __typename?: 'UpdateCustom_listing_categoryPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created custom_listing_category */
  custom_listing_category?: Maybe<Custom_Listing_Category>;
...
/** Input for the updateNft mutation. */
...
/** The payload for the updateNft mutation. */
export type UpdateNftPayload = {
  __typename?: 'UpdateNftPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  nft?: Maybe<Nft>;
...
/** Input for the updateOffer mutation. */
...
/** The payload for the updateOffer mutation. */
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  /** Connection between the User type and the review type */
...
export type UserReviewsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<UserToReviewConnectionWhereArgs>;
};
...
/** Connection between the User type and the review type */
export type UserToReviewConnection = Connection & ReviewConnection & {
  __typename?: 'UserToReviewConnection';
  /** Edges for the UserToReviewConnection connection */
  edges: Array<UserToReviewConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Review>;
  /** Information about pagination in a connection. */
  pageInfo: UserToReviewConnectionPageInfo;
};

/** An edge in a connection */
export type UserToReviewConnectionEdge = Edge & ReviewConnectionEdge & {
...
/** Page Info on the &quot;UserToReviewConnection&quot; */
export type UserToReviewConnectionPageInfo = PageInfo & ReviewConnectionPageInfo & WpPageInfo & {
  __typename?: 'UserToReviewConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type GetAllListingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllListingsQuery = { __typename?: 'RootQuery', customListings?: { __typename?: 'RootQueryToCustom_listingConnection', nodes: Array<{ __typename?: 'Custom_listing', id: string, title?: string | null, reviews?: { __typename?: 'Custom_listing_reviews_connection', nodes: Array<{ __typename?: 'Review', id: string, title?: string | null }>, pageInfo: { __typename?: 'Custom_listing_reviews_connectionPageInfo', total?: number | null } } | null }> } | null };
...
export type GetListingByIdQuery = { __typename?: 'RootQuery', customListing?: { __typename?: 'Custom_listing', id: string, title?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null, reviews?: { __typename?: 'Custom_listing_reviews_connection', nodes: Array<{ __typename?: 'Review', id: string, title?: string | null }>, pageInfo: { __typename?: 'Custom_listing_reviews_connectionPageInfo', total?: number | null } } | null, nfts?: { __typename?: 'Custom_listing_nfts_connection', nodes: Array<{ __typename?: 'Nft', id: string, title?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null }> } | null } | null };

export type GetListingBySlugQueryVariables = Exact<{
  slug: Scalars['ID']['input'];
}>;


export type GetListingBySlugQuery = { __typename?: 'RootQuery', customListing?: { __typename?: 'Custom_listing', id: string, title?: string | null, slug?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null, reviews?: { __typename?: 'Custom_listing_reviews_connection', nodes: Array<{ __typename?: 'Review', id: string, title?: string | null, content?: string | null, date?: string | null, author?: { __typename?: 'NodeWithAuthorToUserConnectionEdge', node: { __typename?: 'User', name?: string | null } } | null }>, pageInfo: { __typename?: 'Custom_listing_reviews_connectionPageInfo', total?: number | null } } | null, nfts?: { __typename?: 'Custom_listing_nfts_connection', nodes: Array<{ __typename?: 'Nft', id: string, title?: string | null, nftAddress?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null }> } | null } | null };
...
export type GetNftByIdQuery = { __typename?: 'RootQuery', nft?: { __typename?: 'Nft', id: string, title?: string | null, excerpt?: string | null, nftAddress?: string | null, nftLinks?: string | null, nftAssets?: { __typename?: 'Nft_nft_assets_connection', nodes: Array<{ __typename?: 'Asset', content?: string | null, title?: string | null, assetTypes?: { __typename?: 'AssetToAsset_typeConnection', nodes: Array<{ __typename?: 'Asset_type', name?: string | null }> } | null }> } | null } | null };

export type GetAssetsByNftAddressQueryVariables = Exact<{
  nftAddress: Scalars['String']['input'];
}>;


export type GetAssetsByNftAddressQuery = { __typename?: 'RootQuery', assets?: { __typename?: 'RootQueryToAssetConnection', nodes: Array<{ __typename?: 'Asset', id: string, title?: string | null, content?: string | null, assetTypes?: { __typename?: 'AssetToAsset_typeConnection', nodes: Array<{ __typename?: 'Asset_type', name?: string | null }> } | null }> } | null };

export type GetNftByAddressQueryVariables = Exact<{
  nftAddress: Scalars['String']['input'];
}>;


export type GetNftByAddressQuery = { __typename?: 'RootQuery', nftByAddress?: { __typename?: 'Nft', id: string, title?: string | null, excerpt?: string | null, nftAddress?: string | null, nftLinks?: string | null, nftListings?: { __typename?: 'Nft_nft_listings_connection', nodes: Array<{ __typename?: 'Custom_listing', title?: string | null, slug?: string | null }> } | null, nftAssets?: { __typename?: 'Nft_nft_assets_connection', nodes: Array<{ __typename?: 'Asset', content?: string | null, title?: string | null, assetTypes?: { __typename?: 'AssetToAsset_typeConnection', nodes: Array<{ __typename?: 'Asset_type', name?: string | null }> } | null }> } | null } | null };



export const GetAllListingsDocument = `
...
export const useGetAllListingsQuery = <
      TData = GetAllListingsQuery,
      TError = unknown
    >(
      variables?: GetAllListingsQueryVariables,
      options?: UseQueryOptions<GetAllListingsQuery, TError, TData>
    ) => {
    
    return useQuery<GetAllListingsQuery, TError, TData>(
      variables === undefined ? ['GetAllListings'] : ['GetAllListings', variables],
      fetcher<GetAllListingsQuery, GetAllListingsQueryVariables>(GetAllListingsDocument, variables),
      options
    )};

export const GetListingByIdDocument = `
...
export const useGetListingByIdQuery = <
      TData = GetListingByIdQuery,
      TError = unknown
    >(
      variables: GetListingByIdQueryVariables,
      options?: UseQueryOptions<GetListingByIdQuery, TError, TData>
    ) => {
    
    return useQuery<GetListingByIdQuery, TError, TData>(
      ['GetListingById', variables],
      fetcher<GetListingByIdQuery, GetListingByIdQueryVariables>(GetListingByIdDocument, variables),
      options
    )};

export const GetListingBySlugDocument = `
...
export const useGetListingBySlugQuery = <
      TData = GetListingBySlugQuery,
      TError = unknown
    >(
      variables: GetListingBySlugQueryVariables,
      options?: UseQueryOptions<GetListingBySlugQuery, TError, TData>
    ) => {
    
    return useQuery<GetListingBySlugQuery, TError, TData>(
      ['GetListingBySlug', variables],
      fetcher<GetListingBySlugQuery, GetListingBySlugQueryVariables>(GetListingBySlugDocument, variables),
      options
    )};

export const GetNftByIdDocument = `
...
export const useGetNftByIdQuery = <
      TData = GetNftByIdQuery,
      TError = unknown
    >(
      variables: GetNftByIdQueryVariables,
      options?: UseQueryOptions<GetNftByIdQuery, TError, TData>
    ) => {
    
    return useQuery<GetNftByIdQuery, TError, TData>(
      ['GetNFTById', variables],
      fetcher<GetNftByIdQuery, GetNftByIdQueryVariables>(GetNftByIdDocument, variables),
      options
    )};

export const GetAssetsByNftAddressDocument = `
...
export const useGetAssetsByNftAddressQuery = <
      TData = GetAssetsByNftAddressQuery,
      TError = unknown
    >(
      variables: GetAssetsByNftAddressQueryVariables,
      options?: UseQueryOptions<GetAssetsByNftAddressQuery, TError, TData>
    ) => {
    
    return useQuery<GetAssetsByNftAddressQuery, TError, TData>(
      ['GetAssetsByNftAddress', variables],
      fetcher<GetAssetsByNftAddressQuery, GetAssetsByNftAddressQueryVariables>(GetAssetsByNftAddressDocument, variables),
      options
    )};

export const GetNftByAddressDocument = `
...
export const useGetNftByAddressQuery = <
      TData = GetNftByAddressQuery,
      TError = unknown
    >(
      variables: GetNftByAddressQueryVariables,
      options?: UseQueryOptions<GetNftByAddressQuery, TError, TData>
    ) => {
    
    return useQuery<GetNftByAddressQuery, TError, TData>(
      ['GetNftByAddress', variables],
      fetcher<GetNftByAddressQuery, GetNftByAddressQueryVariables>(GetNftByAddressDocument, variables),
      options
    )};
